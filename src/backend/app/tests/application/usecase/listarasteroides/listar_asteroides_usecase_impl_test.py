...
class TestListarAsteroidesUseCaseImpl:
    ...
    @patch('src.application.usecase.listarasteroides.listar_asteroides_usecase_impl.ApiAsteroides')
    def test_execute_com_dados_validos_retorna_lista_asteroides(self, mock_api_class):
        ...
        dados_mock = {
            "near_earth_objects": {
                "2024-01-01": [{
                    ...
                    "estimated_diameter": {"kilometers": {"estimated_diameter_min": 0.1}},
        ...
        mock_api_instance.buscar_por_data.assert_called_once_with(data_busca="2024-01-01")
    ...
    @patch('src.application.usecase.listarasteroides.listar_asteroides_usecase_impl.ApiAsteroides')
    def test_execute_com_dados_sem_near_earth_objects_retorna_lista_vazia(self, mock_api_class):
        # Arrange
        mock_api_instance = Mock()
        mock_api_class.return_value = mock_api_instance
