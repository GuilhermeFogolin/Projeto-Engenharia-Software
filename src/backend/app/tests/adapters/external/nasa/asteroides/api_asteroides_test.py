...
class TestApiAsteroides(unittest.TestCase):
    ...
    @patch.dict('os.environ', {'NASA_API_KEY': 'test_api_key', 'NASA_BASE_URL': 'https://api.nasa.gov'})
    ...
    @patch.dict('os.environ', {'NASA_API_KEY': 'test_key_123', 'NASA_BASE_URL': 'https://test.nasa.gov'})
    ...
    def test_buscar_por_data_com_erro_http_retorna_none(self, mock_get):
        ...
        mock_print.assert_called_once_with("Erro ao chamar a API da NASA: 404 Client Error")
    ...
    def test_buscar_por_data_com_erro_conexao_retorna_none(self, mock_get):
        ...
        # Assert
        assert resultado is None
        mock_print.assert_called_once_with("Erro ao chamar a API da NASA: Connection failed")
    ...
    def test_buscar_por_data_com_timeout_retorna_none(self, mock_get):
        ...
        # Assert
        assert resultado is None
        mock_print.assert_called_once_with("Erro ao chamar a API da NASA: Request timeout")
