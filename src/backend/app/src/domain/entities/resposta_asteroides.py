...
class RespostaAsteroides:
    ...
    def _calcular_estatisticas(self):
        ...
        potencialmente_perigosos = sum(
            1 for a in self.asteroides if a.e_potencialmente_perigoso
        )
        ...
        return {
            ...
            "porcentagem_perigosos": (
                round((potencialmente_perigosos / total * 100), 2) if total > 0 else 0
            ),
